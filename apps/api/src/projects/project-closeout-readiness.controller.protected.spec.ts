...
describe('ProjectCloseoutReadinessController protected boundary', () => {
  ...
  it('allows a viewer to read close-out evidence', async () => {
    ...
    const module = await Test.createTestingModule({
      controllers: [ProjectCloseoutReadinessController],
      providers: [{ provide: ProjectCloseoutReadinessService, useValue: service }],
    }).compile()
    ...
    await request(app.getHttpServer())
      .get(`/v1/projects/${PROJECT_ID}/closeout-readiness`)
