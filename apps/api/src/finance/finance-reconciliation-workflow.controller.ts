...
import {
  ...
  FinanceReconciliationImportPipe,
...
export class FinanceReconciliationWorkflowController {
  ...
  importStatement(
    @Body(FinanceReconciliationImportPipe) body: BankStatementImportBody,
  ...
  reconcile(
    @Param('statementId', new ParseUUIDPipe()) statementId: string,
    @Body(FinanceReconciliationReconcilePipe)
