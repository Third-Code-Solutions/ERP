...
export const metadata: Metadata = { title: 'Pipeline List' }
    ...
    <div>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '24px' }}>
        <div className="page-header" style={{ marginBottom: 0 }}>
          <h1 className="page-title">Pipeline List</h1>
      ...
      <div style={{ display: 'flex', gap: '2px', marginBottom: '24px', borderBottom: '1px solid var(--color-border)' }}>
        {[
          ...
          { label: 'Board', href: '/pipeline', active: false },
          { label: 'List', href: '/pipeline/list', active: true },
              ...
              {opps.map((opp) => {
                ...
                return (
                  <tr key={opp.id}>
                    <td>
                      <Link
                        href={opp.project_id ? `/projects/${opp.project_id}` : `/crm/opportunities/${opp.id}`}
