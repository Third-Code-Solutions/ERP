        ...
        <div className="platform-stack">
          ...
          <section className="card">
            ...
            {result.data.rows.length === 0 ? <EmptyPlatformState>No tenants match this view.</EmptyPlatformState> : (
              <div className="platform-table-wrap" tabIndex={0}><table className="data-table"><caption className="sr-only">Tenant directory and lifecycle controls</caption><thead><tr><th scope="col">Tenant</th><th scope="col">Lifecycle</th><th scope="col">Users</th><th scope="col">Projects</th><th scope="col">Last activity</th><th scope="col">Support</th><th scope="col">Change status</th></tr></thead><tbody>
