...
<div style="max-width: 178mm; margin: 0 auto; padding: 0;">
  ...
  <header style="display:flex;justify-content:space-between;align-items:flex-start;border-bottom:3px solid ${BRAND_NAVY};padding-bottom:16px;margin-bottom:24px;">
    <div>
      <div style="display:flex;align-items:center;gap:12px;margin-bottom:6px;">
        <div style="width:36px;height:36px;border-radius:6px;background:${BRAND_NAVY};color:${BRAND_GOLD};display:flex;align-items:center;justify-content:center;font-weight:800;font-size:14px;letter-spacing:-0.02em;">A</div>
        <div>
  ...
  <footer style="margin-top:32px;padding-top:12px;border-top:1px solid ${BORDER};display:flex;justify-content:space-between;align-items:center;font-size:10px;color:${TEXT_DIM};">
    <div style="display:flex;align-items:center;gap:8px;">
      <div style="width:14px;height:14px;border-radius:3px;background:${BRAND_NAVY};color:${BRAND_GOLD};display:flex;align-items:center;justify-content:center;font-weight:800;font-size:8px;">A</div>
      <span>${tenantName} · Weekly Report · ${esc(weekEnding)}</span>
    </div>
    <div>System-generated by ABI OPS</div>
  </footer>
