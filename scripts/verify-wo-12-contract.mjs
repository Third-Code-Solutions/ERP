...
assertIncludes(photoRoute, 'eq(opportunities.tenant_id, profile.tenantId)', 'tenant-scoped photo parent')
assertIncludes(photoRoute, 'writeAuditLogInTransaction(tx', 'photo audit entry')
