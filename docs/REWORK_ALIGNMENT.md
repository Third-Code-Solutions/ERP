...
| Vendor Confirmation | `vendor_confirmation_sessions` + replay ledger | `/v1/public/purchase-orders/:token/confirmation` | Local source authority; session/email provisioning pending |
