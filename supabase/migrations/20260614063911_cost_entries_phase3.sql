-- Phase 3 / F3.2 — Cost Tracking. Additive.
do $$ begin
...
-- Append-only audit (hash chain) via the shared trigger.
...
-- Cortex graph mirror (node_type cost_line; cost_line already in the enum).
