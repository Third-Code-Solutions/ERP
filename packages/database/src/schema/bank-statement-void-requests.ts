...
import { bankStatementVoidRequestStateEnum } from './enums'
import { tenants } from './tenants'
import { users } from './users'

export const bankStatementVoidRequests = pgTable(
  'bank_statement_void_requests',
  {
    ...
    state: bankStatementVoidRequestStateEnum('state')
      .notNull()
      .default('processing'),
    result: jsonb('result'),
  ...
  (table) => ({
    ...
    statementTenantFk: foreignKey({
      name: 'bank_statement_void_requests_statement_tenant_fk',
...
export type BankStatementVoidRequest =
  typeof bankStatementVoidRequests.$inferSelect
export type BankStatementVoidRequestInsert =
  typeof bankStatementVoidRequests.$inferInsert
