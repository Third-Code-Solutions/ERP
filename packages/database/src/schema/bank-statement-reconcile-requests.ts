...
import { bankStatementReconcileRequestStateEnum } from './enums'
import { tenants } from './tenants'
import { users } from './users'

export const bankStatementReconcileRequests = pgTable(
  'bank_statement_reconcile_requests',
  {
    ...
    state: bankStatementReconcileRequestStateEnum('state')
      .notNull()
      .default('processing'),
    result: jsonb('result'),
  ...
  (table) => ({
    ...
    statementTenantFk: foreignKey({
      name: 'bank_statement_reconcile_requests_statement_tenant_fk',
...
export type BankStatementReconcileRequest =
  typeof bankStatementReconcileRequests.$inferSelect
export type BankStatementReconcileRequestInsert =
  typeof bankStatementReconcileRequests.$inferInsert
