...
import { stockMovementCreateRequestStateEnum } from './enums'
import { stockMovements } from './inventory-movements'
import { tenants } from './tenants'
import { users } from './users'

export const stockMovementCreateRequests = pgTable(
  'stock_movement_create_requests',
  {
    ...
    state: stockMovementCreateRequestStateEnum('state')
      .notNull()
      .default('processing'),
  ...
  (table) => ({
    ...
    stockMovementTenantFk: foreignKey({
      name: 'stock_movement_create_requests_stock_movement_tenant_fk',
    ...
    completedAfterCreatedCheck: check(
      'stock_movement_create_requests_completed_after_created',
...
export type StockMovementCreateRequest =
  typeof stockMovementCreateRequests.$inferSelect
export type StockMovementCreateRequestInsert =
  typeof stockMovementCreateRequests.$inferInsert
