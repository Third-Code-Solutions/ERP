...
import { projectCreateRequestStateEnum } from './enums'
...
export const projectCreateRequests = pgTable(
  'project_create_requests',
  {
    ...
    state: projectCreateRequestStateEnum('state')
      .notNull()
      .default('processing'),
  ...
  (table) => ({
    ...
    completedAfterCreatedCheck: check(
      'project_create_requests_completed_after_created',
...
export type ProjectCreateRequestInsert =
  typeof projectCreateRequests.$inferInsert
